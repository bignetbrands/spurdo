...
// exactly da early contributors. dev wallet already sits >5000, so keep headroom
...
export async function runFullScan(): Promise<RevshareData> {
  ...
  // so count failures n surface dem in da diag.
  let closedFail = 0;
